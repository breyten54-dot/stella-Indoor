...
const TEST_EMAIL = `stella.timing.${timestamp}@mailinator.com`;
...
await page.locator('input[placeholder="John Smith"]').fill('Timing Bot');
...
console.log(`Confirmation screen appeared in ${elapsed} ms`);
